# Adds Random Forest model to test if more complex patterns improve prediction. It also removes logP, which forces the
# model to rely more on hydrogen bonding. It also cleans up the table of results and sorted feature importance.
