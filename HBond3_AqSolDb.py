# This code does the same thing as in HydrogenBonding2, but with a different dataset, AqSolDB, to compare it to for
# reproducibility.
...
# ===============================
# Common names in AqSolDB-style datasets
SMILES_COL = None
TARGET_COL = None
...
# Remove invalid SMILES early
df = df[df[SMILES_COL].apply(lambda x: Chem.MolFromSmiles(x) is not None)]

# Optional: reduce size (recommended for capstone)
